...
export default function Testimonial() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-[0.82fr_1.18fr] items-center gap-2 px-3 sm:gap-6 sm:px-6 md:px-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
