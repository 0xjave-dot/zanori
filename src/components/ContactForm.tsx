                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <option value="Virtual Consultation 50,000NGN per hour">Virtual Consultation (50,000 NGN per hour)</option>
                      <option value="Physical Consultation 150,000NGN within Lagos">Physical Consultation (150,000 NGN within Lagos)</option>
                      <option value="Physical Consultation outside Lagos 250,000NGN">Physical Consultation (outside Lagos - 250,000 NGN)</option>
                      <option value="3D Visualization & Moodboard from 200,000NGN">3D Visualization & Moodboard (from 200,000 NGN)</option>
                      <option value="2D Visualization & Moodboard from 100,000NGN">2D Visualization & Moodboard (from 100,000 NGN)</option>
                    </select>
                  </div>
